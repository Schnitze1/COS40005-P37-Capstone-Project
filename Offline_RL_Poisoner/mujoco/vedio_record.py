...
def hopper():
    ...
    bcq = d3rlpy.algos.BC(use_gpu=True)
    # initialize network shapes before loading weights
    bcq.build_with_env(env)
    bcq.load_model("./hopper-medium-v0/BC_20251211171108/model_500000.pt")
