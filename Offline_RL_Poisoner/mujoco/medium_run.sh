...
CUDA_VISIBLE_DEVICES=0 python ./poisoned_mujoco_bear.py --seed=1 --dataset='walker2d-medium-v0' --model='bear_walk_m_params.json' --poison_rate=0.1  &
CUDA_VISIBLE_DEVICES=1 python ./poisoned_mujoco_bcq.py --seed=1 --dataset='walker2d-medium-v0' --model='bcq_walk_m_params.json' --poison_rate=0.1 &

CUDA_VISIBLE_DEVICES=2 python ./poisoned_mujoco_bear.py --seed=1 --dataset='walker2d-medium-v0' --model='bear_walk_m_params.json' --poison_rate=0.2 &
CUDA_VISIBLE_DEVICES=3 python ./poisoned_mujoco_bcq.py --seed=1 --dataset='walker2d-medium-v0' --model='bcq_walk_m_params.json' --poison_rate=0.2 &
#
CUDA_VISIBLE_DEVICES=0 python ./poisoned_mujoco_bear.py --seed=1 --dataset='walker2d-medium-v0' --model='bear_walk_m_params.json' --poison_rate=0.3  &
CUDA_VISIBLE_DEVICES=1 python ./poisoned_mujoco_bcq.py --seed=1 --dataset='walker2d-medium-v0' --model='bcq_walk_m_params.json' --poison_rate=0.3 &
#
CUDA_VISIBLE_DEVICES=2 python ./poisoned_mujoco_bear.py --seed=1 --dataset='walker2d-medium-v0' --model='bear_walk_m_params.json' --poison_rate=0.4 &
CUDA_VISIBLE_DEVICES=3 python ./poisoned_mujoco_bcq.py --seed=1 --dataset='walker2d-medium-v0' --model='bcq_walk_m_params.json' --poison_rate=0.4 &
